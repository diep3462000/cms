 ...
 * @author ngoctv1
 */
class bkManageDoanhThuNgayLinhFormFiltersAdmin extends BasePurchaseMoneyLogFormFilter
{
    ...
    public function doBuildQuery(array $values) {
        ...
        $query->select("DATE(". $alias .".purchasedTime) as created_date," . "p.partnerName as partner_name, sum("
            . $alias . ".parValue) as sum_money, g.cp, sum(" . $alias . ".cashValue) as sum_cash," . $alias . ".purchasedTime, " . $alias . ".type");
