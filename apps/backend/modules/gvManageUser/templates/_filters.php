      ...
      <div class="control-group">
              ...
              <form action="<?php echo url_for('user_collection', array('action' => 'filter')) ?>" method="post">
                  <div class="span11 column-container">
                      ...
                      <?php include_partial('gvManageUser/filters_field', array(
                      'name'       => $name,
                    ...
                    <div class="span2" style="height:50px">
                      ...
                      <?php echo link_to('<i class="icon-remove icon-black"></i> '. __('Reset filter', array(), 'tmcTwitterBootstrapPlugin'), 'user_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'btn')) ?></li>
                    </div>
          ...
          <script type="text/javascript">
              $('#gv_user_filters_lastLoginTime').daterangepicker(
                  {
                      format: 'DD/MM/YYYY',
