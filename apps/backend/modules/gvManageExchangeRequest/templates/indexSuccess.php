...
<!--                </div>-->
            ...
            <h3 style="display: inline"><?php echo __('Tổng đổi thưởng: ', array(), 'messages') ?><?php echo VtHelper::number_format($sum_money) ?> VNĐ</h3></br>
            <h3 style="display: inline"><?php echo __('Tổng Ken: ', array(), 'messages') ?><?php echo VtHelper::number_format($sum_xu_ken["sum_cash"]) ?> Ken</h3></br>
