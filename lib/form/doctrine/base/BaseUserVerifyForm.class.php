...
/**
 * UserVerify form base class.
 *
 * @method UserVerify getObject() Returns the current form's model object
 *
 * @package    Vt_Portals
 * @subpackage form
 * @author     diepth2
 ...
 */
abstract class BaseUserVerifyForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('user_verify[%s]');
