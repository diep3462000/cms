 ...
 * @property integer $disableCashTransaction
 * @property User $User
 * @property ClientType $ClientType
 * @property Partner $Partner
 * @property Doctrine_Collection $MoneyLogs
 * @property Doctrine_Collection $PurchaseMoneyLogs
 * 
 ...
 * @method string              getVerifiedPhone()          Returns the current record's "verifiedPhone" value
 * @method string              getVerifiedEmail()          Returns the current record's "verifiedEmail" value
 * @method integer             getDisableCashTransaction() Returns the current record's "disableCashTransaction" value
 ...
 * @method Doctrine_Collection getPurchaseMoneyLogs()      Returns the current record's "PurchaseMoneyLogs" collection
 ...
 * @method UserInfo            setVerified()               Sets the current record's "verified" value
 * @method UserInfo            setVerifiedPhone()          Sets the current record's "verifiedPhone" value
 * @method UserInfo            setVerifiedEmail()          Sets the current record's "verifiedEmail" value
 * @method UserInfo            setDisableCashTransaction() Sets the current record's "disableCashTransaction" value
 ...
 * @method UserInfo            setPurchaseMoneyLogs()      Sets the current record's "PurchaseMoneyLogs" collection
 * 
 * @package    Vt_Portals
 * @subpackage model
 * @author     diepth2
...
abstract class BaseUserInfo extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('verified', 'integer', 2, array(
             'type' => 'integer',
             'comment' => '0 chưa xác thực, 1 xác thực',
             'length' => 2,
             ));
        $this->hasColumn('verifiedPhone', 'string', 15, array(
             'type' => 'string',
             'comment' => 'sdt xác thực',
             'length' => 15,
             ));
        $this->hasColumn('verifiedEmail', 'string', 15, array(
             'type' => 'string',
             'comment' => 'sdt xác thực',
             'length' => 15,
             ));
        $this->hasColumn('disableCashTransaction', 'integer', 2, array(
             'type' => 'integer',
             'comment' => 'khóa chức năng giao dịch cash',
             'length' => 2,
             ));
    }
    ...
    public function setUp()
    {
        ...
        $this->hasMany('PurchaseMoneyLog as PurchaseMoneyLogs', array(
             'local' => 'userId',
             'foreign' => 'userId'));
    }
}