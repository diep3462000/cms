 ...
 * @property Doctrine_Collection $GuardUser
 * 
 ...
 * @method Doctrine_Collection   getGuardUser()             Returns the current record's "GuardUser" collection
 ...
 * @method sfGuardUser           setGuardUser()             Sets the current record's "GuardUser" collection
 * 
 * @package    Vt_Portals
 * @subpackage model
 * @author     diepth2
...
abstract class BasesfGuardUser extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('VtActionLogs as GuardUser', array(
             'local' => 'id',
             'foreign' => 'actor_id'));
