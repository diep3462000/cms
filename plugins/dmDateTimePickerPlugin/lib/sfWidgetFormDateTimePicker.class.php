...
class sfWidgetFormDateTimePicker extends sfWidgetFormDateTime{
    ...
    protected function renderDateTimePicker($name, $value, $attributes, $errors) {
        ...
        ($value != "") ? $value = date('d-m-Y H:i', strtotime($value)) : $value = "";
        return $widget->render($name, $value, array_merge($attributes, array("class"=>"datetimepicker", "style"=>"width:150px;")), $errors);
    }
